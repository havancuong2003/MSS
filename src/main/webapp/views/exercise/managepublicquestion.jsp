        ...
        <div class="pagination-container">
            <ul class="pagination">
                <c:if test="${searchtxt != null}" >
                    <c:if test="${tag > 1}">
                        <li class="page-item"><a href="manage-public-question?page=${tag-1}&search=${searchtxt}&course_id=${course_id}">Previous</a></li>
                    </c:if>
                    <c:if test="${tag ==1}">
                    ...
                    <c:forEach begin="1" end="${endPage}" var="i">
                        <li class="page-item ${i == tag ? 'active' : ''}">
                            <a href="manage-public-question?page=${i}&search=${searchtxt}&course_id=${course_id}">${i}</a>
                        </li>
                    </c:forEach>
                    <c:if test="${tag < endPage}" >
                        <li class="page-item" ><a href="manage-public-question?page=${tag+1}&search=${searchtxt}&course_id=${course_id}" class="page-link">Next</a></li>
                    </c:if>
                    <c:if test="${tag == endPage}">
                ...
                <c:if test="${searchtxt == null}">
                    <c:if test="${tag > 1}">
                        <li class="page-item"><a href="manage-public-question?page=${tag-1}&type_question=${type_question}&status_question=${status_question}&course_id=${course_id}">Previous</a></li>
                    </c:if>
                    <c:if test="${tag ==1}">
                        <li class="page-item"><a href="#">Previous</a></li>
                    </c:if>
                    <c:forEach begin="1" end="${endPage}" var="i">
                        <li class="page-item ${i == tag ? 'active' : ''}">
                            <a href="manage-public-question?page=${i}&type_question=${type_question}&status_question=${status_question}&course_id=${course_id}">${i}</a>
                        </li>
                    </c:forEach>
                    <c:if test="${tag < endPage}" >
                        <li class="page-item" ><a href="manage-public-question?page=${tag+1}&type_question=${type_question}&status_question=${status_question}&course_id=${course_id}" class="page-link">Next</a></li>
                    </c:if>
                    <c:if test="${tag == endPage}">
                        <li class="page-item" ><a href="#" class="page-link">Next</a></li>
                    </c:if>
