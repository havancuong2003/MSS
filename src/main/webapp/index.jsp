            ...
            >
                ...
                >
                    <div class="navbar-nav py-0">
                        ...
                        >About</a
                        >
                        <a href="${pageContext.request.contextPath}/views/landing_page/landingPAGE/course.jsp" class="nav-item nav-link"
                        >Courses</a
                        >
                        <a href="${pageContext.request.contextPath}/views/landing_page/landingPAGE/teacher.jsp" class="nav-item nav-link"
                        >Teachers</a
                        >
                        <div class="nav-item dropdown">
                            <a
                            ...
                            <div class="dropdown-menu rounded-0 m-0">
                                <a
                                        href="${pageContext.request.contextPath}/views/landing_page/landingPAGE/blog.jsp"
                                        class="dropdown-item"
                                >Blog List</a
                                >
                                <a
                                        href="${pageContext.request.contextPath}/views/landing_page/landingPAGE/single.jsp"
                                        class="dropdown-item"
                                >Blog Detail</a
                                >
                            </div>
                    ...
                    <a
                            href="${pageContext.request.contextPath}/views/landing_page/landingPAGE/login.jsp"
